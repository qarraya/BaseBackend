export const mealCategories = {
    ...
    LUNCH: [
        { name: "سلطة دجاج مشوي", calories: 344, portion: "300غ", fats: 20, proteins: 32, carbs: 9, ingredients: ["150غ صدر دجاج مشوي", "كوبين خس", "طماطم وخيار", "ملعقتين صلصة خل وزيت"], imageUrl: "https://www.greatgrubdeliciTreats.com/wp-content/uploads/2022/05/Grilled_Chicken_Salad_13.jpg", incompatibleDiseases: [] },
    ...
    DINNER: [
        ...
        { name: "برجر لحم صحي بخبز القمح الكامل", calories: 430, portion: "250غ", fats: 18, proteins: 32, carbs: 35, ingredients: ["قطعة برجر لحم مشوي", "خبز برجر أسمر", "شريحة جبن لايت", "خس وطماطم"], imageUrl: "https://images.unsplash.com/photo-1508736793122-f516e3ba5569?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8SGVhbHRoeSUyMGJlZWYlMjBidXJnZXIlMjB3GoleJTIwd2hlYXQlMjBidW58ZW58MHx8MHx8fDA%3D", incompatibleDiseases: ["أمراض القلب"] }
    ],
    SNACK: [
