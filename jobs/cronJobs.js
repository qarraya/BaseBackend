...
// 🔹 Only run cron jobs if ENABLE_CRONS is set to true
// This allows us to run the backend on Vercel (API) and Render (Cron Worker) simultaneously.
if (process.env.ENABLE_CRONS === "true") {
    console.log("🚀 Cron jobs are ENABLED on this instance.");
    ...
    console.log("ℹ️ Cron jobs are DISABLED on this instance (ENABLE_CRONS is not true).");
}
