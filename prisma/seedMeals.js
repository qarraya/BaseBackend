...
const mealCategories = {
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1590412200988-a436bb705300?auto=format&fit=crop&w=600&q=80",
  ...
  },
  {
    ...
    imageUrl: "https://images.pexels.com/photos/15456108/pexels-photo-15456108.jpeg?auto=compress&cs=tinysrgb&w=600",
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1536511132640-5e26ec0ea79d?auto=format&fit=crop&w=600&q=80",
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1594610655964-b0337c3f30b9?auto=format&fit=crop&w=600&q=80",
  ...
  { name: "سلطة يونانية بجبنة الفيتا", calories: 286, portion: "300غ", fats: 22, proteins: 10, carbs: 12, ingredients: ["طماطم وخيار وزيتون", "50غ جبن فيتا", "ملعقة زيت زيتون"], imageUrl: "https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?auto=format&fit=crop&w=600&q=80", incompatibleDiseases: ["ارتفاع ضغط الدم"] },
  { name: "دجاج مشوي مع كوسا وجزر", calories: 310, portion: "250غ", fats: 10, proteins: 35, carbs: 20, ingredients: ["150غ دجاج مشوي", "كوسا وجزر مسلوق", "رشة فلفل أسود"], imageUrl: "https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?auto=format&fit=crop&w=600&q=80", incompatibleDiseases: [] },
  { name: "راب فلافل مخبوزة بالفرن", calories: 348, portion: "200غ", fats: 12, proteins: 15, carbs: 45, ingredients: ["3 حبات فلافل مشوية", "خبز صاج أسمر", "طحينة وسلطة"], imageUrl: "https://images.unsplash.com/photo-1547058886-af3a3aad4da3?auto=format&fit=crop&w=600&q=80", incompatibleDiseases: [] },
  { name: "شوربة دجاج بالخضار", calories: 222, portion: "350مل", fats: 6, proteins: 20, carbs: 22, ingredients: ["مرق دجاج", "قطع دجاج صغيرة", "ذرة وجزر", "بقدونس"], imageUrl: "https://images.unsplash.com/photo-1607532941433-304659e8198a?auto=format&fit=crop&w=600&q=80", incompatibleDiseases: [] },
  { name: "بطاطا مشوية محشوة بالجبن والخضار", calories: 358, portion: "250غ", fats: 14, proteins: 12, carbs: 46, ingredients: ["حبة بطاطا مشوية", "ملعقتان جبن موزاريلا", "بروكلي مقطع"], imageUrl: "https://images.unsplash.com/photo-1585238342024-78d387f4a707?auto=format&fit=crop&w=600&q=80", incompatibleDiseases: ["السكري"] },
  { name: "سلطة كينوا بالرمان والبقدونس", calories: 298, portion: "250غ", fats: 10, proteins: 8, carbs: 44, ingredients: ["نصف كوب كينوا", "ربع كوب رمان", "بقدونس وليمون", "ملعقة زيت زيتون"], imageUrl: "https://images.unsplash.com/photo-1505576399279-565b52d4ac71?auto=format&fit=crop&w=600&q=80", incompatibleDiseases: [] },
  { name: "لحم مفروم مع باذنجان مشوي", calories: 388, portion: "300غ", fats: 20, proteins: 30, carbs: 22, ingredients: ["100غ لحم بقري مفروم", "باذنجان مشوي بالفرن", "صلصة طماطم طبيعية"], imageUrl: "https://images.pexels.com/photos/7451817/pexels-photo-7451817.jpeg?auto=compress&cs=tinysrgb&w=600", incompatibleDiseases: [] },
  { name: "بيضتان مسلوقتان مع سلطة جرجير", calories: 210, portion: "200غ", fats: 14, proteins: 15, carbs: 6, ingredients: ["بيضتان مسلوقتان", "جرجير وطماطم كرزية", "عصير ليمون"], imageUrl: "https://images.unsplash.com/photo-1587486913049-53fc88980cfc?auto=format&fit=crop&w=600&q=80", incompatibleDiseases: ["ارتفاع الكوليسترول"] },
  { name: "شاورما دجاج صحية", calories: 360, portion: "200غ", fats: 12, proteins: 28, carbs: 35, ingredients: ["100غ دجاج متبل ببهارات شاورما", "خبز أسمر رقيق", "سلطة ومخلل"], imageUrl: "https://images.unsplash.com/photo-1626700051175-6518c4793f4f?auto=format&fit=crop&w=600&q=80", incompatibleDiseases: [] },
  { name: "برجر لحم صحي بخبز القمح الكامل", calories: 430, portion: "250غ", fats: 18, proteins: 32, carbs: 35, ingredients: ["قطعة برجر لحم مشوي", "خبز برجر أسمر", "شريحة جبن لايت", "خس وطماطم"], imageUrl: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?auto=format&fit=crop&w=600&q=80", incompatibleDiseases: ["أمراض القلب"] }
],
    SNACK: [
  ...
  { name: "شرائح جزر وخيار مع حمص", calories: 154, portion: "150غ", fats: 6, proteins: 5, carbs: 20, ingredients: ["خيار وجزر مقطع", "ملعقتان حمص"], imageUrl: "https://images.unsplash.com/photo-1541532713592-79a0317b6b77?auto=format&fit=crop&w=600&q=80", incompatibleDiseases: [] },
  { name: "قطعة شوكولاتة داكنة", calories: 120, portion: "20غ", fats: 8, proteins: 2, carbs: 10, ingredients: ["مكعبان شوكولاتة داكنة 70% كاكاو"], imageUrl: "https://images.unsplash.com/photo-1548907040-4d42b3228b3a?auto=format&fit=crop&w=600&q=80", incompatibleDiseases: [] },
  { name: "كعك الأرز مع زبدة لوز", calories: 185, portion: "50غ", fats: 9, proteins: 6, carbs: 20, ingredients: ["حبتان كعك أرز", "ملعقة زبدة لوز"], imageUrl: "https://images.unsplash.com/photo-1590080875515-8a3a8dc5735e?auto=format&fit=crop&w=600&q=80", incompatibleDiseases: ["حساسية المكسرات"] },
  ...
  { name: "زبدية شوفان صغيرة", calories: 155, portion: "100غ", fats: 3, proteins: 5, carbs: 27, ingredients: ["ربع كوب شوفان", "نصف كوب ماء أو حليب دافئ"], imageUrl: "https://images.unsplash.com/photo-1517686469429-8faf88b9f7af?auto=format&fit=crop&w=600&q=80", incompatibleDiseases: [] },
  { name: "شرائح بطيخ مع نعناع", calories: 92, portion: "250غ", fats: 0, proteins: 2, carbs: 21, ingredients: ["كوبان بطيخ مقطع", "أوراق نعناع طازجة"], imageUrl: "https://images.unsplash.com/photo-1587049352851-8d4e89134292?auto=format&fit=crop&w=600&q=80", incompatibleDiseases: ["السكري"] },
  ...
  { name: "نصف حبة جريب فروت", calories: 56, portion: "150غ", fats: 0, proteins: 1, carbs: 13, ingredients: ["نصف حبة جريب فروت طازجة"], imageUrl: "https://images.unsplash.com/photo-1552089123-2d26226fc2b7?auto=format&fit=crop&w=600&q=80", incompatibleDiseases: [] },
  { name: "تمر محشي بزبدة الفول السوداني", calories: 200, portion: "50غ", fats: 8, proteins: 4, carbs: 28, ingredients: ["حبتان تمر", "ملعقة صغيرة زبدة فول سوداني"], imageUrl: "https://images.pexels.com/photos/15014902/pexels-photo-15014902.jpeg?auto=compress&cs=tinysrgb&w=600", incompatibleDiseases: ["السكري", "حساسية المكسرات"] },
  { name: "كرات الطاقة بالشوفان والتمر", calories: 211, portion: "50غ", fats: 7, proteins: 5, carbs: 32, ingredients: ["حبتان كرات طاقة محضرة منزلياً"], imageUrl: "https://images.unsplash.com/photo-1604497181005-343516584285?auto=format&fit=crop&w=600&q=80", incompatibleDiseases: [] },
  { name: "عنب وقطع جبن شيدر", calories: 182, portion: "100غ", fats: 10, proteins: 8, carbs: 15, ingredients: ["نصف كوب عنب", "قطعتان صغيرتان جبن شيدر"], imageUrl: "https://images.unsplash.com/photo-1601314002592-b8730b2683d5?auto=format&fit=crop&w=600&q=80", incompatibleDiseases: [] }
