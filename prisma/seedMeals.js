...
const mealCategories = {
    BREAKFAST: [
        ...
        },
        {
            ...
            imageUrl: "https://images.unsplash.com/photo-1761166638721-5783a5b1f815?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTZ8fEZvdWwlMjBtdWRhbW1hc3xlbnwwfHwwfHx8MA%3D%3D",
    ...
    LUNCH: [
        ...
        { name: "كفتة مشوية مع سلطة", calories: 334, portion: "250غ", fats: 21.5, proteins: 26.5, carbs: 8.5, ingredients: ["150غ لحم مفروم مشوي", "بصل وبقدونس", "سلطة تبولة صغيرة"], imageUrl: "https://images.unsplash.com/photo-1693422661212-82a6ed1f0417?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8R3JpbGxlZCUyMGtvZnRhJTIwd2l0aCUyMHNhbGFkfGVufDB8fDB8fHww", incompatibleDiseases: ["أمراض القلب", "ارتفاع ضغط الدم"] },
        { name: "مجدرة", calories: 397, portion: "350غ", fats: 5, proteins: 18, carbs: 70, ingredients: ["كوب عدس مطبوخ", "نصف كوب أرز مسلوق", "بصل مقلي", "بهارات"], imageUrl: "https://images.unsplash.com/photo-1578248399127-07bc095dc942?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8TGVudGlscyUyMGFuZCUyMHJpY2UlMjBib3dsJTIwd2l0aCUyMG9uaW9uc3xlbnwwfHwwfHx8MA%3D%3D", incompatibleDiseases: [] },
    ...
    DINNER: [
        ...
        { name: "تونة مع سلطة خضراء", calories: 262, portion: "250غ", fats: 10, proteins: 28, carbs: 15, ingredients: ["علبة تونة مصفاة من الزيت", "خس وجرجير", "عصير ليمون"], imageUrl: "https://images.unsplash.com/photo-1604497181015-76590d828b75?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8VHVuYSUyMGdyZWVuJTIwc2FsYWR8ZW58MHx8MHx8fDA%3D", incompatibleDiseases: ["ارتفاع ضغط الدم"] },
        ...
        { name: "جبنة قريش مع فواكه", calories: 225, portion: "200غ", fats: 5, proteins: 20, carbs: 25, ingredients: ["كوب جبنة قريش", "نصف تفاحة أو بطيخ", "رشة جوز"], imageUrl: "https://images.unsplash.com/photo-1631718051263-c567dca19362?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Q290dGFnZSUyMGNoZWVzZSUyMHdpdGglMjBmcnVpdHxlbnwwfHwwfHx8MA%3D%3D", incompatibleDiseases: ["أمراض الكلى المزمنة"] },
    ...
    SNACK: [
        ...
        { name: "مكسرات مشكلة", calories: 222, portion: "30غ", fats: 18, proteins: 7, carbs: 8, ingredients: ["30غ مكسرات غير مملحة (كاجو، جوز، لوز)"], imageUrl: "https://images.unsplash.com/photo-1601436423581-9c59173e52d4?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8SGVhbHRoeSUyMG51dHMlMjBzbmFja3xlbnwwfHwwfHx8MA%3D%3D", incompatibleDiseases: [] },
        { name: "زبادي سادة", calories: 108, portion: "150غ", fats: 4, proteins: 8, carbs: 10, ingredients: ["علبة زبادي 150غ"], imageUrl: "https://images.unsplash.com/photo-1571212515416-fef01fc43637?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8UGxhaW4lMjB5b2d1cnR8ZW58MHx8MHx8fDA%3D", incompatibleDiseases: [] },
        { name: "تمر وجوز", calories: 242, portion: "50غ", fats: 10, proteins: 3, carbs: 35, ingredients: ["3 حبات تمر", "نصف كوب جوز"], imageUrl: "https://images.unsplash.com/photo-1540914482491-3e1ad1098db7?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8RGF0ZXMlMjBhbmQlMjB3YWxudXRzfGVufDB8fDB8fHww", incompatibleDiseases: ["السكري"] },
